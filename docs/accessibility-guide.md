...
This is applied globally in `core/variables.css` (overriding timing tokens) and targeted specifically in `core/animations.css` to prevent affecting non-animation classes:

```css
@media (prefers-reduced-motion: reduce) {
  :root {
    --ease-speed-fast: 0.01ms !important;
    --ease-speed-medium: 0.01ms !important;
    --ease-speed-slow: 0.01ms !important;
    --ease-animation-iterations: 1 !important;
    --ease-duration-float: 0.01ms !important;
    --ease-duration-pulse-emphasis: 0.01ms !important;
    --ease-duration-shimmer: 0.01ms !important;
    --ease-duration-pulse: 0.01ms !important;
    --ease-duration-gradient: 0.01ms !important;
  }
}
```
