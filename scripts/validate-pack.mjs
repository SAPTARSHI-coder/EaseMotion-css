...
const required = [
  ...
  "components/announce-bar.css",
  "components/avatar.css",
  "components/breadcrumb.css",
  "components/btn-magnetic.css",
  "components/command-palette.css",
  "components/compare-table.css",
  ...
  "components/read-more.css",
  "components/scroll-gallery.css",
  "components/skeleton.css",
  "components/tag.css",
  "components/toast.css",
  "components/view-transitions.css",
  "easemotion/all.css",
