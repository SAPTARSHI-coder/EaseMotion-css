# Introduce utility for text truncation with ellipsis

CSS utility for single and multi-line text truncation.

## Usage

Add the `ease-truncate` class to any HTML element:

```html
<div class="ease-truncate">
  Your content here
</div>
```
