# ---  ## 11. ease-morph-icon-set  **Title** ```text [FEATURE] ease-morph-icon-set

> Submission for issue [#68000](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68000) — ---  ## 11. ease-morph-icon-set  **Title** ```text [FEATURE] ease-morph-icon-set

## Overview
This submission adds a **---  ## 11. ease-morph-icon-set  **Title** ```text [FEATURE] ease-morph-icon-set** CSS component demo to EaseMotion CSS. It is a
