...
The core objective of **Future Mobility Operations Center** is to build a premium, highly responsive engineering console demonstrating:
...
- **Secondary Color (`--secondary-hsl`)**: `hsl(260, 85%, 60%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(135, 75%, 45%)` - Callouts and interactive states.
