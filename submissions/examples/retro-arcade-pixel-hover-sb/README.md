# Retro Arcade Pixel Hover Effects - (ease-retro-arcade-pixel-hover)

> Pure HTML &amp; vanilla CSS example for the EaseMotion CSS submissions track.
> Resolves issue #73382.

## What

A self-contained **Retro Arcade Pixel** hover effects demo built with pure CSS keyframes
...
| `style.css` | Raw CSS implementing the `ease-retro-arcade-pixel-hover` motion. |
