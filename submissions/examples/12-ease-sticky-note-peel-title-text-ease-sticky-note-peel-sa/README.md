# ---  ## 12. ease-sticky-note-peel  **Title** ```text [FEATURE] ease-sticky-note-peel

> Submission for issue [#67998](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67998) — ---  ## 12. ease-sticky-note-peel  **Title** ```text [FEATURE] ease-sticky-note-peel

## Overview
This submission adds a **---  ## 12. ease-sticky-note-peel  **Title** ```text [FEATURE] ease-sticky-note-peel** CSS component demo to EaseMotion CSS. It is a
