# ---  ## 15. ease-carousel-3d  **Title** ```text [FEATURE] ease-carousel-3d

> Submission for issue [#68007](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68007) — ---  ## 15. ease-carousel-3d  **Title** ```text [FEATURE] ease-carousel-3d

## Overview
This submission adds a **---  ## 15. ease-carousel-3d  **Title** ```text [FEATURE] ease-carousel-3d** CSS component demo to EaseMotion CSS. It is a
