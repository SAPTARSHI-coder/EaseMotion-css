...
| `ease-stagger-fast-4` | 0.2s  |
| `ease-stagger-fast-5` | 0.25s |

## Classes (Slow Speed - 2s total)
...
| `ease-stagger-slow-4` | 0.8s  |
| `ease-stagger-slow-5` | 1.0s  |
...
<!-- Slow speed -->
<div class="ease-stagger-slow-1">Slow 1</div>
<div class="ease-stagger-slow-2">Slow 2</div>
```
