...
Demonstrates CSS intrinsic sizing keywords `min-content`, `max-content`, and `fit-content` on width. Each box shows how text content is sized ΓÇö from shrinking to the longest word (`min-content`) to expanding to the full unwrapped line (`max-content`), with `fit-content` clamping between the two.
