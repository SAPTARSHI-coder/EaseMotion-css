# Clip Path Keyframes Absolute Coordinates Fix

Resolves **#87376**

## Overview
Enforces strictly absolute SVG coordinates (M, C) to ensure fluid, hardware-accelerated morphing in @keyframes clip-path transitions.
