# ---  ## 8. ease-map-pin-drop  **Title** ```text [FEATURE] ease-map-pin-drop

> Submission for issue [#67957](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67957) — ---  ## 8. ease-map-pin-drop  **Title** ```text [FEATURE] ease-map-pin-drop

## Overview
This submission adds a **---  ## 8. ease-map-pin-drop  **Title** ```text [FEATURE] ease-map-pin-drop** CSS component demo to EaseMotion CSS. It is a
