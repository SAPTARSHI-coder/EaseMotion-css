# ---  ## 16. ease-heatmap-grid  **Title** ```text [FEATURE] ease-heatmap-grid

> Submission for issue [#68005](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68005) — ---  ## 16. ease-heatmap-grid  **Title** ```text [FEATURE] ease-heatmap-grid

## Overview
This submission adds a **---  ## 16. ease-heatmap-grid  **Title** ```text [FEATURE] ease-heatmap-grid** CSS component demo to EaseMotion CSS. It is a
