...
```html
&lt;!-- Trigger --&gt; &lt;a href="#toast-success" class="toast-trigger-pr
toast-trigger-success-pr"&gt; Show Success &lt;/a&gt; &lt;!-- Toast --&gt;
&lt;div id="toast-success" class="toast-pr toast-success-pr"&gt; &lt;div
class="toast-icon-pr"&gt;✓&lt;/div&gt; &lt;div class="toast-content-pr"&gt;
&lt;div class="toast-title-pr"&gt;Success!&lt;/div&gt; &lt;div
class="toast-message-pr"&gt;Your changes have been saved.&lt;/div&gt;
&lt;/div&gt; &lt;a href="#hide" class="toast-close-pr"&gt;×&lt;/a&gt; &lt;div
class="toast-progress-pr"&gt;&lt;/div&gt; &lt;/div&gt; &lt;!-- Hidden anchor for
closing --&gt; &lt;div id="hide" style="display: none;"&gt;&lt;/div&gt;
```
