...
> Submission for issue [#67008](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67008) — [FEATURE] ease-otp-input

## Overview
This submission adds a **ease-otp-input** CSS component demo to EaseMotion CSS. It is a
