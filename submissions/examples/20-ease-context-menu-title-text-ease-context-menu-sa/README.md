# ---  ## 20. ease-context-menu  **Title** ```text [FEATURE] ease-context-menu

> Submission for issue [#68012](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68012) — ---  ## 20. ease-context-menu  **Title** ```text [FEATURE] ease-context-menu

## Overview
This submission adds a **---  ## 20. ease-context-menu  **Title** ```text [FEATURE] ease-context-menu** CSS component demo to EaseMotion CSS. It is a
