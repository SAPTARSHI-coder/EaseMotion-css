# ---  ## 10. ease-split-text-reveal  **Title** ```text [FEATURE] ease-split-text-reveal

> Submission for issue [#67959](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67959) — ---  ## 10. ease-split-text-reveal  **Title** ```text [FEATURE] ease-split-text-reveal

## Overview
This submission adds a **---  ## 10. ease-split-text-reveal  **Title** ```text [FEATURE] ease-split-text-reveal** CSS component demo to EaseMotion CSS. It is a
