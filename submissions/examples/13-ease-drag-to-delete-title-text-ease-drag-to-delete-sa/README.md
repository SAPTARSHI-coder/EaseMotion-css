# ---  ## 13. ease-drag-to-delete  **Title** ```text [FEATURE] ease-drag-to-delete

> Submission for issue [#68004](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68004) — ---  ## 13. ease-drag-to-delete  **Title** ```text [FEATURE] ease-drag-to-delete

## Overview
This submission adds a **---  ## 13. ease-drag-to-delete  **Title** ```text [FEATURE] ease-drag-to-delete** CSS component demo to EaseMotion CSS. It is a
