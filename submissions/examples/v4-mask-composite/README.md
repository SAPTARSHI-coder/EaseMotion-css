# Mask Composite Exclude Artifact Fix

Resolves **#80501**

## Overview
Forces will-change: mask to allocate GPU surfaces, resolving solid black Chromium masking artifacts on pseudo-elements.
