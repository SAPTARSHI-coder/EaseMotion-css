...
CSS utility classes for controlling text-rendering font-smooth -webkit-font-smoothing font-kerning in HTML elements.

## Installation

```bash
# Via CSS @import
@import "text-rendering-optimize-tm/style.css";
```
...
- `text-rendering`: Chrome 55+, Firefox 6+, Safari 5.1+, Edge 79+
