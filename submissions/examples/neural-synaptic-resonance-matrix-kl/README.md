...
### Triggering Action Potentials Programmatically
To trigger a high-voltage impulse burst programmatically, trigger the click handler or call the DOM stimulation function:

```javascript
const triggerBtn = document.getElementById('trigger-action-potential-btn');
triggerBtn.click();
```
...
## References & Credits
*   Cajal, S. R. (Histology of the Nervous System).
