...
```html
&lt;!-- Automatic via OS setting --&gt; &lt;body class="dark-mode-demo-pr"&gt;
... &lt;/body&gt; &lt;!-- Manual toggle --&gt; &lt;body class="dark-mode-demo-pr
dark-active-pr"&gt; ... &lt;/body&gt; &lt;!-- Toggle with JavaScript --&gt;
&lt;button onclick="document.body.classList.toggle('dark-active-pr')"&gt; Toggle
Dark Mode &lt;/button&gt;
```
