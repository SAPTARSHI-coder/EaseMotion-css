...
class ModernComponent {
  ...
  mount() {
    ...
    this.statusLog.innerHTML =
      'Status: Component Mounted! Scroll to trigger events. <br><br> <strong style="color: #166534;">✅ window.addEventListener successfully attached.</strong>';
  ...
  unmount() {
    ...
    this.statusLog.innerHTML =
      'Status: Component Unmounted. <br><br> <strong style="color: #e11d48;">✅ window.removeEventListener flawlessly executed. Zero memory leaks!</strong>';
    console.log(
      "[Component Unmounted] Global scroll listener cleanly eradicated."
    );
  }

  handleScroll() {
    console.log(
      `[Component Event] Window mathematically scrolled at ${new Date().toLocaleTimeString()}`
    );
  }
}
