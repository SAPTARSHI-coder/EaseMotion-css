# Implement animated scroll-to-top button

An animated scroll-to-top button component.

## Usage

Add the `ease-scroll-top` class to any HTML element:

```html
<div class="ease-scroll-top">
  Your content here
</div>
```
