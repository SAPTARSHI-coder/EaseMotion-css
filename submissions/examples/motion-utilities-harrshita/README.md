# Add motion utilities using CSS transitions

CSS transition utility classes for smooth UI animations.

## Usage

Add the `ease-motion` class to any HTML element:

```html
<div class="ease-motion">
  Your content here
</div>
```
