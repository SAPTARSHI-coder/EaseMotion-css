# ---  # 16. `ease-modal-scale`  ### 1️⃣ Title ```text [FEATURE] ease-modal-scale

> Submission for issue [#66918](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66918) — ---  # 16. `ease-modal-scale`  ### 1️⃣ Title ```text [FEATURE] ease-modal-scale

## Overview
This submission adds a **---  # 16. `ease-modal-scale`  ### 1️⃣ Title ```text [FEATURE] ease-modal-scale** CSS component demo to EaseMotion CSS. It is a
