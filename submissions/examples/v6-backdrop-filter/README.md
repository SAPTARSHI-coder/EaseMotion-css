# Backdrop Filter Clipping Artifact Fix

Resolves **#87383**

## Overview
Forces hardware acceleration clipping using overflow: hidden and radial mask gradients to prevent backdrop-filter blur artifacts at rounded corners.
