...
1. **What does this do?**
   A full visual redesign of the EaseMotion CSS documentation landing page — tighter typography, a polished hero section, philosophy cards, live animation previews, copy buttons on code blocks, install tabs, and a contributing pipeline diagram.
