# ---  # 15. `ease-tooltip-arrow`  ### 1️⃣ Title ```text [FEATURE] ease-tooltip-arrow

> Submission for issue [#66917](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66917) — ---  # 15. `ease-tooltip-arrow`  ### 1️⃣ Title ```text [FEATURE] ease-tooltip-arrow

## Overview
This submission adds a **---  # 15. `ease-tooltip-arrow`  ### 1️⃣ Title ```text [FEATURE] ease-tooltip-arrow** CSS component demo to EaseMotion CSS. It is a
