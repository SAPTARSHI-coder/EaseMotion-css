# Particle Burst Hover Effects - (ease-particle-burst-hover)

> Pure HTML &amp; vanilla CSS example for the EaseMotion CSS submissions track.
> Resolves issue #73380.

## What

A self-contained **Particle Burst** hover effects demo built with pure CSS keyframes
...
| `style.css` | Raw CSS implementing the `ease-particle-burst-hover` motion. |
