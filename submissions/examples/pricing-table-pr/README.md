...
```html
&lt;div class="pricing-pr"&gt; &lt;div class="pricing-card-pr"&gt; &lt;h3
class="pricing-name-pr"&gt;Basic&lt;/h3&gt; &lt;p
class="pricing-desc-pr"&gt;Description here&lt;/p&gt; &lt;div
class="pricing-price-pr"&gt; &lt;span
class="pricing-currency-pr"&gt;$&lt;/span&gt; &lt;span
class="pricing-amount-pr"&gt;29&lt;/span&gt; &lt;span
class="pricing-period-pr"&gt;/month&lt;/span&gt; &lt;/div&gt; &lt;ul
class="pricing-features-pr"&gt; &lt;li class="pricing-feature-pr"&gt;Included
feature&lt;/li&gt; &lt;li class="pricing-feature-pr is-missing-pr"&gt;Not
included&lt;/li&gt; &lt;/ul&gt; &lt;a href="#" class="pricing-cta-pr
pricing-cta-primary-pr"&gt;Get Started&lt;/a&gt; &lt;/div&gt; &lt;/div&gt;
```
