# ---  ## 9. ease-progress-ring  **Title** ```text [FEATURE] ease-progress-ring

> Submission for issue [#67960](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67960) — ---  ## 9. ease-progress-ring  **Title** ```text [FEATURE] ease-progress-ring

## Overview
This submission adds a **---  ## 9. ease-progress-ring  **Title** ```text [FEATURE] ease-progress-ring** CSS component demo to EaseMotion CSS. It is a
