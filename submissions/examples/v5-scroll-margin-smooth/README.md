# Scroll Margin Smooth Scrolling Fix

Resolves **#83320**

## Overview
Uses padding-top and negative margin-top hacks to preserve scroll anchor offsets on pages with scroll-behavior: smooth.
