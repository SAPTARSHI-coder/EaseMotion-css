...
class="testimonial-quote-pr"&gt;"&lt;/span&gt; &lt;div
class="testimonial-stars-pr"&gt;★★★★★&lt;/div&gt; &lt;p
class="testimonial-text-pr"&gt;Quote text here...&lt;/p&gt; &lt;div
class="testimonial-author-pr"&gt; &lt;img src="avatar.jpg" alt="Name"
class="testimonial-avatar-pr" /&gt; &lt;div&gt; &lt;p
class="testimonial-name-pr"&gt;Author Name&lt;/p&gt; &lt;p
class="testimonial-role-pr"&gt;Role at Company&lt;/p&gt; &lt;/div&gt;
&lt;/div&gt; &lt;/div&gt;
```
