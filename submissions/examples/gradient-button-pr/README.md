...
```html
&lt;button class="gradient-button-pr"&gt;Click me&lt;/button&gt; &lt;button
class="gradient-button-pr ease-btn-sm"&gt;Small&lt;/button&gt; &lt;button
class="gradient-button-pr ease-btn-lg ease-btn-pill"&gt;Large
Pill&lt;/button&gt; &lt;button class="gradient-button-pr"
