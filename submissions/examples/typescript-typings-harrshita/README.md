# Provide TypeScript typings for all components

TypeScript type definitions for all EaseMotion CSS components.

## Usage

Add the `ease-types` class to any HTML element:

```html
<div class="ease-types">
  Your content here
</div>
```
