...
## What does this do?
This utility provides an interactive, modern neumorphic soft shadow hover effect that smoothly transitions between extruded and inset depth profiles.

## How is it used?
<button type="button" class="neu-card">
  <h3>smooth state transition</h3>
  <p>transforms effortlessly between raised convex surface and inset extruded states on hover or press.</p>
</button>

## Why is it useful?
It introduces a pure CSS neumorphic tactile effect optimized for dark themes without triggering heavy layout shifts or requiring external script frameworks.


# Detailed Explanation COMPONENT FOR EASEMOTION 
