...
<div class="tk-card">
  ...
  <div class="tk-details">
    <div class="tk-row">
      <span class="tk-row-label">Plan</span
      ><span class="tk-row-value">Pro</span>
    </div>
    <hr class="tk-divider" />
    <div class="tk-row tk-total">
      <span class="tk-row-label">Total</span
      ><span class="tk-row-value">$299</span>
    </div>
  </div>
