# ---  # 13. `ease-checkbox-check`  ### 1️⃣ Title ```text [FEATURE] ease-checkbox-check

> Submission for issue [#66914](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66914) — ---  # 13. `ease-checkbox-check`  ### 1️⃣ Title ```text [FEATURE] ease-checkbox-check

## Overview
This submission adds a **---  # 13. `ease-checkbox-check`  ### 1️⃣ Title ```text [FEATURE] ease-checkbox-check** CSS component demo to EaseMotion CSS. It is a
