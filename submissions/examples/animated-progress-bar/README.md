...
<div
  class="ease-progress ease-progress-loaded"
  style="--ease-progress-value: 45%;"
>
  <div
    class="ease-progress-bar ease-progress-striped ease-progress-animated"
  ></div>
</div>
