# Animation Composition Accumulation Fix

Resolves **#87388**

## Overview
Provides composite utility wrappers that isolate keyframes from hover transforms to prevent animation-composition: add from accumulating infinitely.
