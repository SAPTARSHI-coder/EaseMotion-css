# Provide a guide for contributing new components

A detailed guide for contributing new components to EaseMotion CSS.

## Usage

Add the `ease-guide` class to any HTML element:

```html
<div class="ease-guide">
  Your content here
</div>
```
