# CSS Hamburger to X Transition

> Submission for issue [#68181](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68181) — [FEATURE] CSS Hamburger to X Transition

## Overview
This submission adds a **CSS Hamburger to X Transition** CSS component demo to EaseMotion CSS. It is a
