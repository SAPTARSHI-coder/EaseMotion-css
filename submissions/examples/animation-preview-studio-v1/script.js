...
function applyAnimation() {
  ...
  previewBox.style.animationDuration = duration.value + "s";

  previewBox.style.animationDelay = delay.value + "s";

  previewBox.style.animationIterationCount = iterations.value;

  animationName.textContent = animation.className;
...
document.getElementById("playBtn").addEventListener("click", applyAnimation);
...
document.getElementById("copyBtn").addEventListener("click", async () => {
  const className = animations[select.value].className;
