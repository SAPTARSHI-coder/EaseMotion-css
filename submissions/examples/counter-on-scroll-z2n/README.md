# css counter on scroll

## What does this do?
This utility triggers a smooth numeric count-up animation as statistical metrics scroll into the browser viewport.

## How is it used?
<article class="counter-card">
  <div class="counter-num counter-stat-1" aria-label="500 thousand active users"></div>
  <h3>active users</h3>
  <p>global developers building daily.</p>
</article>

## Why is it useful?
It achieves an animated numerical statistic counter using pure CSS `@property` keyframes and scroll-driven view timelines without relying on JavaScript observer scripts.
