# Add CSS variable based color palette

A structured CSS custom property color palette system.

## Usage

Add the `ease-palette` class to any HTML element:

```html
<div class="ease-palette">
  Your content here
</div>
```
