...
> Submission for issue [#68249](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68249) — [FEATURE] CSS Notification Badge

## Overview
This submission adds a **CSS Notification Badge** CSS component demo to EaseMotion CSS. It is a
