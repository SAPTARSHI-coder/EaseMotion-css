# Quantum Energy Shield Hover Effects - (ease-quantum-energy-shield-hover)

> Pure HTML &amp; vanilla CSS example for the EaseMotion CSS submissions track.
> Resolves issue #73383.

## What

A self-contained **Quantum Energy Shield** hover effects demo built with pure CSS keyframes
...
| `style.css` | Raw CSS implementing the `ease-quantum-energy-shield-hover` motion. |
