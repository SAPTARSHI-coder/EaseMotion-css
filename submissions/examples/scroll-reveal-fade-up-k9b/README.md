...
## What does this do?
This utility smoothly reveals content cards and headers by translating them upward while increasing opacity as they enter the browser viewport.

## How is it used?
<article class="reveal-card reveal-delay-1">
  <h3>Pure CSS Driven</h3>
  <p>Elements fade upward effortlessly into view as the page is scrolled.</p>
</article>

## Why is it useful?
It provides a lightweight, pure CSS scroll-reveal utility that leverages modern native scroll timelines without requiring heavy JavaScript observer scripts.
