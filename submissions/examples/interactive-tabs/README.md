...
## Included Files
- `tabs.css`: The reusable, scalable component CSS.
- `demo.html`: A functional example demonstrating the component.

## Integration
Once the core engine contribution freeze is lifted, `tabs.css` can be merged into `easemotion/components/tabs.css`.
