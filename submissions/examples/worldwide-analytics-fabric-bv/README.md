...
The core objective of **Worldwide Analytics Fabric** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(200, 85%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(320, 85%, 60%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(175, 80%, 45%)` - Callouts and interactive states.
