# ---  # 18. `ease-navbar-shrink`  ### 1️⃣ Title ```text [FEATURE] ease-navbar-shrink

> Submission for issue [#66923](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66923) — ---  # 18. `ease-navbar-shrink`  ### 1️⃣ Title ```text [FEATURE] ease-navbar-shrink

## Overview
This submission adds a **---  # 18. `ease-navbar-shrink`  ### 1️⃣ Title ```text [FEATURE] ease-navbar-shrink** CSS component demo to EaseMotion CSS. It is a
