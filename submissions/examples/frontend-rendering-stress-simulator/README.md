...
2. Select a **Rendering Pipeline**: _GPU Composited (Transform)_ or _CPU Reflow (Top/Left)_.
...
5. Switch the **"Target Device Profile"** to _Mobile Throttled_ to evaluate budget margins on lower-end client hardware.
