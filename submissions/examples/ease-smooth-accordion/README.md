# EaseAccordion Component (`ease-smooth-accordion`)

A zero-dependency, pure CSS layout module for displaying responsive, smoothly animating interactive accordion panels.
