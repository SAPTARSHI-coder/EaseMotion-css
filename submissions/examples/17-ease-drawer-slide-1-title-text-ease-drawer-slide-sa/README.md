# ---  # 17. `ease-drawer-slide`  ### 1️⃣ Title ```text [FEATURE] ease-drawer-slide

> Submission for issue [#66922](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66922) — ---  # 17. `ease-drawer-slide`  ### 1️⃣ Title ```text [FEATURE] ease-drawer-slide

## Overview
This submission adds a **---  # 17. `ease-drawer-slide`  ### 1️⃣ Title ```text [FEATURE] ease-drawer-slide** CSS component demo to EaseMotion CSS. It is a
