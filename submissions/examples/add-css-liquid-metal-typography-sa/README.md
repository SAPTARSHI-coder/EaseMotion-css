...
> Submission for issue [#66159](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66159) — feat: Add CSS Liquid Metal Typography

## Overview
This submission adds a **Liquid Metal Typography** CSS component demo to EaseMotion CSS. It is a
