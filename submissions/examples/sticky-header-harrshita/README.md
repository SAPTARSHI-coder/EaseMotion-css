# Implement sticky header utility

A sticky header utility with scroll-aware behavior.

## Usage

Add the `ease-sticky-header` class to any HTML element:

```html
<div class="ease-sticky-header">
  Your content here
</div>
```
