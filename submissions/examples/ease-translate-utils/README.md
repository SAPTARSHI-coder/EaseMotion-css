...
| `ease-translate-x-4` | translateX(1rem) |

| `ease-translate-x-8` | translateX(2rem) |
...
| `ease-translate-y-4` | translateY(1rem) |

| `ease-translate-y-8` | translateY(2rem) |
...
| `ease-translate-half` | translateX(50%) |
