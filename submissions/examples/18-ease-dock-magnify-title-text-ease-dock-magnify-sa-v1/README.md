# ---  ## 18. ease-dock-magnify  **Title** ```text [FEATURE] ease-dock-magnify

> Submission for issue [#68008](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68008) — ---  ## 18. ease-dock-magnify  **Title** ```text [FEATURE] ease-dock-magnify

## Overview
This submission adds a **---  ## 18. ease-dock-magnify  **Title** ```text [FEATURE] ease-dock-magnify** CSS component demo to EaseMotion CSS. It is a
