# ---  ## 19. ease-spotlight-search  **Title** ```text [FEATURE] ease-spotlight-search

> Submission for issue [#68013](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68013) — ---  ## 19. ease-spotlight-search  **Title** ```text [FEATURE] ease-spotlight-search

## Overview
This submission adds a **---  ## 19. ease-spotlight-search  **Title** ```text [FEATURE] ease-spotlight-search** CSS component demo to EaseMotion CSS. It is a
