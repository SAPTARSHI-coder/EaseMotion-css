...
Currently, developers are explicitly defining CSS columns and rows, but violently ignoring what happens when a React state array or Headless CMS dynamically injects _extra_ items into the grid:
