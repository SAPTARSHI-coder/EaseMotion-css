...
```html
&lt;div class="ease-upload"&gt; &lt;input type="file" class="ease-upload__input"
multiple&gt; &lt;div class="ease-upload__icon"&gt;...&lt;/div&gt; &lt;p
class="ease-upload__title"&gt;Click or drag files here&lt;/p&gt; &lt;/div&gt;
```
