...
The core objective of **Smart Energy Grid Dashboard** is to build a premium, highly responsive engineering console demonstrating:
...
- **Primary Color (`--primary-hsl`)**: `hsl(45, 95%, 50%)` - Primary branding accents.
- **Secondary Color (`--secondary-hsl`)**: `hsl(220, 85%, 55%)` - Secondary metrics lines.
- **Accent Color (`--accent-hsl`)**: `hsl(150, 80%, 45%)` - Callouts and interactive states.
