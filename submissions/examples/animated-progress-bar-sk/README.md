...
<div class="ease-progress-wrapper">
  ...
  <div
    class="ease-progress ease-progress-primary"
...
<div
  class="ease-progress ease-progress-sm ease-progress-success"
...
<div
  class="ease-progress ease-progress-lg ease-progress-warning"
  style="--progress-value: 85%;"
>
...
<div
  class="ease-progress ease-progress-primary ease-progress-gradient ease-progress-striped ease-progress-pill"
  style="--progress-value: 90%;"
>
  <div class="ease-progress-bar"></div>
</div>
```
