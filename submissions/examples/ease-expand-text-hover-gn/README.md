...
3. **Why is it useful?**
   Letter-spacing expansion is one of the most elegant micro-interactions for headings and nav links. It works entirely in CSS using transition on letter-spacing, zero JavaScript, and includes prefers-reduced-motion support.
