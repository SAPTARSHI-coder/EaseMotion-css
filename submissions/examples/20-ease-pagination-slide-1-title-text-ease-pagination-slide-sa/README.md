# ---  # 20. `ease-pagination-slide`  ### 1️⃣ Title ```text [FEATURE] ease-pagination-slide

> Submission for issue [#66927](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/66927) — ---  # 20. `ease-pagination-slide`  ### 1️⃣ Title ```text [FEATURE] ease-pagination-slide

## Overview
This submission adds a **---  # 20. `ease-pagination-slide`  ### 1️⃣ Title ```text [FEATURE] ease-pagination-slide** CSS component demo to EaseMotion CSS. It is a
