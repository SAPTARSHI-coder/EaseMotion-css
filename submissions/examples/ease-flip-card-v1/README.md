...
Submission for Issue #51322 — Animated 3D Flip Card Component
...
| Class | Description |
|---|---|
| `ease-flip-card--click` | Switches trigger from hover to click |
...
- Pure CSS transform, no content removed from the DOM.
- Recommend `aria-pressed` on the click-trigger element.
