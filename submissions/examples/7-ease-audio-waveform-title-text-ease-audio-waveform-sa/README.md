# ---  ## 7. ease-audio-waveform  **Title** ```text [FEATURE] ease-audio-waveform

> Submission for issue [#67958](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/67958) — ---  ## 7. ease-audio-waveform  **Title** ```text [FEATURE] ease-audio-waveform

## Overview
This submission adds a **---  ## 7. ease-audio-waveform  **Title** ```text [FEATURE] ease-audio-waveform** CSS component demo to EaseMotion CSS. It is a
