# Laser Ray Trace Hover Effects - (ease-laser-ray-trace-hover)

> Pure HTML &amp; vanilla CSS example for the EaseMotion CSS submissions track.
> Resolves issue #73379.

## What

A self-contained **Laser Ray Trace** hover effects demo built with pure CSS keyframes
...
| `style.css` | Raw CSS implementing the `ease-laser-ray-trace-hover` motion. |
