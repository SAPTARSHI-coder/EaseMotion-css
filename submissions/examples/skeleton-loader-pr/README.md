...
```html
&lt;!-- Basic card skeleton --&gt; &lt;div class="skeleton-card-pr"&gt; &lt;div
class="skeleton-loader-pr skeleton-image-pr"&gt;&lt;/div&gt; &lt;div
class="skeleton-loader-pr skeleton-title-pr"&gt;&lt;/div&gt; &lt;div
class="skeleton-loader-pr skeleton-text-pr"&gt;&lt;/div&gt; &lt;/div&gt; &lt;!--
Inside existing EaseMotion card --&gt; &lt;div class="ease-card"&gt; &lt;div
class="skeleton-loader-pr skeleton-image-pr"&gt;&lt;/div&gt; &lt;div
class="ease-card-body"&gt; &lt;div class="skeleton-loader-pr
skeleton-title-pr"&gt;&lt;/div&gt; &lt;/div&gt; &lt;/div&gt;
```
