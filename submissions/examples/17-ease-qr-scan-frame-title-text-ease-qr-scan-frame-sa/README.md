# ---  ## 17. ease-qr-scan-frame  **Title** ```text [FEATURE] ease-qr-scan-frame

> Submission for issue [#68009](https://github.com/SAPTARSHI-coder/EaseMotion-css/issues/68009) — ---  ## 17. ease-qr-scan-frame  **Title** ```text [FEATURE] ease-qr-scan-frame

## Overview
This submission adds a **---  ## 17. ease-qr-scan-frame  **Title** ```text [FEATURE] ease-qr-scan-frame** CSS component demo to EaseMotion CSS. It is a
