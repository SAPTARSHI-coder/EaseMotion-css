...
Breadcrumb navigation trail for [EaseMotion CSS](https://github.com/SAPTARSHI-coder/EaseMotion-css).
...
| Class | Description |
|-------|-------------|
| `ease-breadcrumb--compact` | Reduced padding and smaller font |
| `ease-breadcrumb--primary` | Filled primary color variant |
| `ease-breadcrumb--outlined` | Outlined border variant |
...
|----------|---------|-------------|
| `--ease-breadcrumb-color` | `#6c63ff` | Accent color |
| `--ease-breadcrumb-bg` | `#f8f8ff` | Background color |
| `--ease-breadcrumb-radius` | `6px` | Border radius |
| `--ease-breadcrumb-transition` | `0.25s ease` | Animation timing |
| `--ease-breadcrumb-shadow` | box-shadow value | Shadow style |
...
| File | Description |
|------|-------------|
| `EaseBreadcrumb.jsx` | React component source |
