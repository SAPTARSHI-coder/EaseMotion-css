...
Top navigation bar for [EaseMotion CSS](https://github.com/SAPTARSHI-coder/EaseMotion-css).
...
| Class | Description |
|-------|-------------|
| `ease-navbar--compact` | Reduced padding and smaller font |
| `ease-navbar--primary` | Filled primary color variant |
| `ease-navbar--outlined` | Outlined border variant |
...
|----------|---------|-------------|
| `--ease-navbar-color` | `#6c63ff` | Accent color |
| `--ease-navbar-bg` | `#f8f8ff` | Background color |
| `--ease-navbar-radius` | `6px` | Border radius |
| `--ease-navbar-transition` | `0.25s ease` | Animation timing |
| `--ease-navbar-shadow` | box-shadow value | Shadow style |
...
| File | Description |
|------|-------------|
| `EaseNavbar.jsx` | React component source |
