...
Dismissible alert messages for [EaseMotion CSS](https://github.com/SAPTARSHI-coder/EaseMotion-css).
...
| Class | Description |
|-------|-------------|
| `ease-alert--compact` | Reduced padding and smaller font |
| `ease-alert--primary` | Filled primary color variant |
| `ease-alert--outlined` | Outlined border variant |
...
|----------|---------|-------------|
| `--ease-alert-color` | `#6c63ff` | Accent color |
| `--ease-alert-bg` | `#f8f8ff` | Background color |
| `--ease-alert-radius` | `6px` | Border radius |
| `--ease-alert-transition` | `0.25s ease` | Animation timing |
| `--ease-alert-shadow` | box-shadow value | Shadow style |
...
| File | Description |
|------|-------------|
| `EaseAlert.jsx` | React component source |
