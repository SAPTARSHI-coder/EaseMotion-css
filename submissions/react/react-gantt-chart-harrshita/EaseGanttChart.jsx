...
const EaseGanttChart = ({ tasks }) => {
  return (
    <div className="ease-gantt-container">
      <div className="ease-gantt-header">
        <div className="ease-gantt-task-col">Task Name</div>
        <div className="ease-gantt-timeline-col">Timeline</div>
      </div>
      <div className="ease-gantt-body">
        {tasks.map(task => (
          <div key={task.id} className="ease-gantt-row">
            <div className="ease-gantt-task-col">{task.name}</div>
            <div className="ease-gantt-timeline-col">
              <div 
                className="ease-gantt-bar" 
                style={{ 
