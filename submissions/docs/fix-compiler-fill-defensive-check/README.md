...
```css
animation: ease-kf-fade-in 300ms cubic-bezier(...) undefined;
```

This produces invalid CSS that browsers may ignore or mishandle. The defensive check ensures clean CSS output.
