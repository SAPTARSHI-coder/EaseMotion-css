...
.ease-reveal-fade {
  animation-name: ease-reveal-fade-kf;
}
.ease-reveal-up {
  animation-name: ease-reveal-up-kf;
}
.ease-reveal-down {
  animation-name: ease-reveal-down-kf;
}
.ease-reveal-left {
  animation-name: ease-reveal-left-kf;
}
.ease-reveal-right {
  animation-name: ease-reveal-right-kf;
}
.ease-reveal-zoom {
  animation-name: ease-reveal-zoom-kf;
}
.ease-reveal-rotate {
  animation-name: ease-reveal-rotate-kf;
}
```
