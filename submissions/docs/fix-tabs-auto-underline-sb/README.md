...
- The static `border-bottom` indicator displays properly as intended
- Ensures users get the expected behavior when using variable-width tabs
- Follows CSS best practices for handling specificity conflicts
