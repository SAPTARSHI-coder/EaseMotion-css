...
### 3. Why is it useful?
Without this check, if `ast.fill` is `undefined`, the generated CSS will contain `undefined` as a literal string, producing invalid CSS that browsers may ignore.
