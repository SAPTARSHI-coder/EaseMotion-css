# Pastel Segmented Control — accessibility integration

Documentation guide for the **Pastel Segmented Control** component, focused on **accessibility integration**.

## Overview
Accessibility guide for the pastel segmented control: role=radiogroup/single-select semantics, aria-pressed, focus-visible, reduced-motion.
...
- `.ease-pastel-segmented-control-a11y` — root container
- `.ease-pastel-segmented-control-a11y__<element>` — BEM-style child elements
