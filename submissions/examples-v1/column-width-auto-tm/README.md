# column-width-auto-tm

## CSS CSS column-width auto multi-column layout

A comprehensive CSS utility class for **CSS column-width auto multi-column layout**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-column-width-auto-tm">
  <span>CSS column-width auto multi-column layout</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-column-width-auto-tm tm-column-width-auto-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-column-width-auto-tm tm-column-width-auto-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-column-width-auto-tm tm-column-width-auto-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-column-width-auto-tm tm-column-width-auto-tm-variant-4">
