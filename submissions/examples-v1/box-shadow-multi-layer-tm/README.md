# box-shadow-multi-layer-tm

## CSS CSS multi-layer shadow depth utilities

A comprehensive CSS utility class for **CSS multi-layer shadow depth utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-box-shadow-multi-layer-tm">
  <span>CSS multi-layer shadow depth utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div
  class="tm-box-shadow-multi-layer-tm tm-box-shadow-multi-layer-tm-variant-1"
>
...
<div
  class="tm-box-shadow-multi-layer-tm tm-box-shadow-multi-layer-tm-variant-2"
>
...
<div
  class="tm-box-shadow-multi-layer-tm tm-box-shadow-multi-layer-tm-variant-3"
>
...
<div
  class="tm-box-shadow-multi-layer-tm tm-box-shadow-multi-layer-tm-variant-4"
>
