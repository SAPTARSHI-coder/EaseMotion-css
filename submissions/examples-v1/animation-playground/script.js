...
const durationMap = {
  "ease-duration-300": "300ms",
  "ease-duration-500": "500ms",
  "ease-duration-700": "700ms",
  "ease-duration-1000": "1000ms",
  "ease-duration-1500": "1500ms",
};
const delayMap = {
  "": "0ms",
...
const timingMap = {
  ...
  "ease-timing-ease-in": "ease-in",
  "ease-timing-ease-out": "ease-out",
  "ease-timing-ease-in-out": "ease-in-out",
};
const iterationMap = {
  "ease-once": "1",
  "ease-twice": "2",
  "ease-infinite": "infinite",
};
const directionMap = {
  "ease-normal": "normal",
  "ease-reverse": "reverse",
  "ease-alternate": "alternate",
};
