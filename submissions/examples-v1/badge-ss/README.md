...
```html
&lt;!-- Solid --&gt; &lt;span class="ease-badge
ease-badge-primary"&gt;New&lt;/span&gt; &lt;!-- Outline --&gt; &lt;span
class="ease-badge ease-badge-outline-success"&gt;Active&lt;/span&gt; &lt;!--
Soft --&gt; &lt;span class="ease-badge
ease-badge-soft-danger"&gt;Urgent&lt;/span&gt; &lt;!-- With dot --&gt; &lt;span
class="ease-badge ease-badge-dot ease-badge-soft-success"&gt;Online&lt;/span&gt;
&lt;!-- With pulse --&gt; &lt;span class="ease-badge ease-badge-primary
ease-badge-pulse"&gt;Live&lt;/span&gt; &lt;!-- With counter --&gt; &lt;span
class="ease-badge ease-badge-primary ease-badge-counter"
data-count="3"&gt;Inbox&lt;/span&gt; &lt;!-- Removable --&gt; &lt;span
class="ease-badge ease-badge-soft-primary ease-badge-removable"&gt; Tag &lt;span
class="ease-badge-close"&gt;×&lt;/span&gt; &lt;/span&gt;
```
