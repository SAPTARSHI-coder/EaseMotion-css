...
<div class="ease-avatar ease-avatar-md ease-avatar-circle">
  ...
  <span
    class="ease-avatar-status ease-status-online"
    aria-label="Online"
  ></span>
</div>
```
...
<div class="ease-avatar-group">
  <div
    class="ease-avatar ease-avatar-md ease-avatar-circle ease-avatar-group-item"
  >
  ...
  <div
    class="ease-avatar ease-avatar-md ease-avatar-circle ease-avatar-group-item ease-avatar-initials group-more"
  >
    <span>+5</span>
  </div>
</div>
