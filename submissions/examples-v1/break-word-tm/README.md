...
Text and font styling utilities for readability and visual hierarchy.

This submission provides a comprehensive set of CSS utility classes for **CSS Break Word Utilities**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/break-word-tm/style.css" />
```
...
```
submissions/examples/break-word-tm/
  demo.html    — Interactive demo with live examples
  style.css    — 151+ meaningful CSS lines
