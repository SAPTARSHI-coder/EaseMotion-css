# Border Style — EaseMotion CSS Utilities

CSS `border-style` utility classes for the EaseMotion CSS framework.
...
```html
<div class="util-class-dark">Dark mode Border Style</div>
```
...
```html
<div class="util-class-nomotion">No motion Border Style</div>
```
