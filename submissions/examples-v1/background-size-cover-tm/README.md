...
## CSS CSS background-size cover utilities

A comprehensive CSS utility class for **CSS background-size cover utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-background-size-cover-tm">
  <span>CSS background-size cover utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-background-size-cover-tm tm-background-size-cover-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-background-size-cover-tm tm-background-size-cover-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-background-size-cover-tm tm-background-size-cover-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-background-size-cover-tm tm-background-size-cover-tm-variant-4">
