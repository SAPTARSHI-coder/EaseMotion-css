...
## CSS CSS align-content multi-line alignment

A comprehensive CSS utility class for **CSS align-content multi-line alignment**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-align-content-tm">
  <span>CSS align-content multi-line alignment</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-align-content-tm tm-align-content-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-align-content-tm tm-align-content-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-align-content-tm tm-align-content-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-align-content-tm tm-align-content-tm-variant-4">
