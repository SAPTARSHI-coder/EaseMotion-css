...
```html
<div class="blob blob-fast"></div>
<!-- 3s cycle -->
<div class="blob"></div>
<!-- 6s cycle (default) -->
<div class="blob blob-slow"></div>
<!-- 8s cycle -->
```
...
```html
<div class="blob blob-blur"></div>
<!-- soft diffuse glow -->
<div class="blob blob-glow"></div>
<!-- box-shadow halo -->
<div class="blob blob-outline"></div>
<!-- transparent, colored border -->
<div class="blob blob-pause-hover"></div>
<!-- freezes on hover -->
```
...
<section style="position: relative; overflow: hidden;">
  ...
  <div
    class="blob blob-blue blob-blur blob-decorative blob-slow"
