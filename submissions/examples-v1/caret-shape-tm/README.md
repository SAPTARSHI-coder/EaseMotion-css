...
## CSS CSS caret-shape cursor shape utilities

A comprehensive CSS utility class for **CSS caret-shape cursor shape utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-caret-shape-tm">
  <span>CSS caret-shape cursor shape utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-caret-shape-tm tm-caret-shape-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-caret-shape-tm tm-caret-shape-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-caret-shape-tm tm-caret-shape-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-caret-shape-tm tm-caret-shape-tm-variant-4">
