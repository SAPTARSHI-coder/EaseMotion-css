...
- Layered card layout for depth perception

## 🎯 Reusable Utility Classes

- `ease-fade-in` → smooth fade animation
- `ease-slide-up` → scroll-based upward motion
- `ease-hover-grow` → hover scaling effect
