...
<div class="ease-checkmark-wrapper ease-animate">
  ...
  <div class="ease-burst-container">
    <div
      class="particle"
      style="--angle: 0deg; --distance: 70px; --color: #4ade80; --size: 6px;"
    ></div>
    <div
      class="particle"
      style="--angle: 45deg; --distance: 80px; --color: #60a5fa; --size: 8px;"
    ></div>
    <div
      class="particle"
      style="--angle: 90deg; --distance: 65px; --color: #f43f5e; --size: 5px;"
    ></div>
    <div
      class="particle"
      style="--angle: 135deg; --distance: 75px; --color: #fbbf24; --size: 7px;"
    ></div>
    <div
      class="particle"
      style="--angle: 180deg; --distance: 90px; --color: #c084fc; --size: 6px;"
    ></div>
    <div
      class="particle"
      style="--angle: 225deg; --distance: 70px; --color: #2dd4bf; --size: 8px;"
    ></div>
    <div
      class="particle"
      style="--angle: 270deg; --distance: 85px; --color: #fbbf24; --size: 5px;"
    ></div>
    <div
      class="particle"
      style="--angle: 315deg; --distance: 60px; --color: #f43f5e; --size: 7px;"
    ></div>
  </div>
</div>
```
