...
<div
  class="toast-notification ease-fade-out-down exit-fast exit-translate-short"
>
  Dismissing toast...
</div>
```
...
<div
  class="custom-card ease-fade-out-down"
  style="--ease-fade-out-down-translate: 40px; --ease-fade-out-down-duration: 0.5s;"
>
