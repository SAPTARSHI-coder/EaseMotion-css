# Dice &amp; Friends – Board Games E‑commerce Landing Page
...
- **Game of the Month** – featured product with rating and details
- **Reviews and Ratings** – customer testimonials
- **Gift Finder Quiz** – CTA for a recommendation quiz
...
- **Hover Effects:** `ease-hover-scale-105`, `ease-hover-shadow-xl`, `ease-hover-text-yellow-700`
