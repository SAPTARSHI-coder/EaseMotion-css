...
CSS color-mix() function utilities that blend EaseMotion design tokens with white and black to generate harmonious color variants. Supports primary, success, danger, warning, secondary, info, and neutral color palettes.

## Features

- Demonstrates color-mix() css utility using EaseMotion CSS design tokens
