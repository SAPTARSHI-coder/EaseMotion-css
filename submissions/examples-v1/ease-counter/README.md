...
<!-- Count to 100 -->
<span
  class="ease-counter ease-counter--100 ease-counter--lg ease-counter--green"
></span>

<!-- Count to 500 with + suffix, slow -->
<span
  class="ease-counter ease-counter--500 ease-counter--suffix-plus ease-counter--slow"
></span>

<!-- Scroll-triggered count to 1000 -->
<span
  class="ease-counter ease-counter--scroll ease-counter--1000 ease-counter--xl"
></span>
```
