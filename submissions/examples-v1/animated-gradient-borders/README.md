...
<div class="ease-gradient-border">
  <div class="ease-gradient-border-inner">Your content here</div>
</div>

<!-- Glow border -->
<div class="ease-gradient-border-glow">Your content here</div>

<!-- Hover reveal -->
<div class="ease-gradient-border-hover">Your content here</div>
```
