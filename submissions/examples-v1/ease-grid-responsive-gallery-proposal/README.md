...
_Note: As per the contributing guidelines, this proposal is implemented inside a unique `submissions/examples/ease-grid-responsive-gallery-proposal/` directory to avoid directly modifying core files and causing zero deletions. The maintainer can safely migrate this utility to the core layout stylesheet._
