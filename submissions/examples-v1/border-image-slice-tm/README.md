# border-image-slice-tm

## CSS CSS border-image-slice slicing utilities

A comprehensive CSS utility class for **CSS border-image-slice slicing utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-border-image-slice-tm">
  <span>CSS border-image-slice slicing utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-border-image-slice-tm tm-border-image-slice-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-border-image-slice-tm tm-border-image-slice-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-border-image-slice-tm tm-border-image-slice-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-border-image-slice-tm tm-border-image-slice-tm-variant-4">
