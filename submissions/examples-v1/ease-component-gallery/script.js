const components = [
  ...
  // ── Cards ─────────────────────────────────────────────
  {
    ...
    render: () =>
      `<div class="ease-card" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Title</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Card content here.</p></div>`,
  },
  {
    name: "Shadow Card",
    category: "cards",
    ...
    render: () =>
      `<div class="ease-card ease-card-shadow" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Shadow Card</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Elevated content container.</p></div>`,
  },
  {
    name: "Hover Card",
    category: "cards",
    ...
    render: () =>
      `<div class="ease-card ease-card-shadow ease-card-hover" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Hover Card</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Hover to see lift effect.</p></div>`,
  },
  {
    name: "Glass Card",
    category: "cards",
    ...
    render: () =>
      `<div class="ease-card ease-card-glass" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Glass Card</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Frosted glass effect.</p></div>`,
  },
  {
    ...
    render: () =>
      `<div class="ease-card ease-card-neumorphic" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Neumorphic</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Soft UI style.</p></div>`,
  },
  {
    name: "Accent Card",
    category: "cards",
    ...
    render: () =>
      `<div class="ease-card ease-card-accent" style="padding:16px;width:100%;"><h3 class="ease-card-title" style="margin:0 0 4px;">Accent Card</h3><p style="margin:0;font-size:13px;color:var(--text-secondary);">Highlighted with accent border.</p></div>`,
  },
  // ── Animations ────────────────────────────────────────
  {
    name: "Fade In",
    ...
    render: () =>
      `<div class="ease-fade-in" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Fade In</div>`,
  },
  {
    name: "Slide Up",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-slide-up" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Slide Up</div>`,
  },
  {
    name: "Slide Left",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-slide-left" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Slide Left</div>`,
  },
  {
    name: "Slide Right",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-slide-right" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Slide Right</div>`,
  },
  {
    name: "Zoom In",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-zoom-in" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Zoom In</div>`,
  },
  {
    name: "Bounce",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-bounce" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Bounce</div>`,
  },
  {
    name: "Pulse",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-pulse" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:14px;">Pulse</div>`,
  },
  {
    name: "Rotate",
    category: "animations",
    ...
    render: () =>
      `<div class="ease-rotate" style="padding:8px 16px;background:var(--accent);color:#fff;border-radius:8px;font-weight:600;font-size:18px;">⟳</div>`,
  },
  // ── Hover Effects ─────────────────────────────────────
  {
    name: "Hover Grow",
    ...
    render: () =>
      `<button class="ease-btn ease-btn-primary ease-hover-grow">Grow</button>`,
  },
  {
    name: "Hover Glow",
    category: "hover",
    ...
    render: () =>
      `<button class="ease-btn ease-btn-primary ease-hover-glow">Glow</button>`,
  },
  {
    name: "Hover Lift",
    category: "hover",
    ...
    render: () =>
      `<button class="ease-btn ease-btn-primary ease-hover-lift">Lift</button>`,
  },
  {
    name: "Hover Shimmer",
    category: "hover",
    ...
    render: () =>
      `<button class="ease-btn ease-btn-primary ease-hover-shimmer">Shimmer</button>`,
  },
  {
    ...
    render: () =>
      `<span class="ease-hover-underline" style="font-size:14px;font-weight:600;">Underline</span>`,
  },
  // ── Utilities ──────────────────────────────────────────
  {
    name: "Flex Center",
    ...
    render: () =>
      `<div class="ease-flex ease-items-center ease-justify-center" style="width:100%;height:60px;background:var(--accent-light);border-radius:8px;font-size:13px;font-weight:600;">Centered Content</div>`,
  },
  {
    name: "Flex Between",
    category: "utilities",
    ...
    render: () =>
      `<div class="ease-flex ease-justify-between ease-items-center" style="width:100%;padding:8px 12px;background:var(--accent-light);border-radius:8px;font-size:13px;"><span>Left</span><span>Right</span></div>`,
  },
  {
    name: "Grid Auto",
    category: "utilities",
  ...
  },
  {
    ...
    render: () =>
      `<div class="ease-text-center" style="width:100%;font-size:14px;font-weight:600;">Centered Text</div>`,
  },
  // ── Navbar ─────────────────────────────────────────────
  {
    name: "Glass Navbar",
    ...
    render: () =>
      `<nav class="ease-navbar-glass" style="width:100%;padding:10px 16px;display:flex;justify-content:space-between;align-items:center;border-radius:8px;"><span style="font-weight:700;font-size:14px;">Logo</span><span style="display:flex;gap:12px;font-size:12px;"><span>Home</span><span>Docs</span></span></nav>`,
  },
  {
    ...
    render: () =>
      `<nav class="ease-navbar-glass" style="width:100%;padding:10px 16px;display:flex;justify-content:space-between;align-items:center;border-radius:8px;"><span style="font-weight:700;font-size:14px;">Sticky</span><span style="display:flex;gap:12px;font-size:12px;"><span>Home</span><span>Docs</span></span></nav>`,
  },
  {
    ...
    render: () =>
      `<nav class="ease-navbar-glass ease-navbar-glass-blur" style="width:100%;padding:10px 16px;display:flex;justify-content:space-between;align-items:center;border-radius:8px;"><span style="font-weight:700;font-size:14px;">Blur</span><span style="display:flex;gap:12px;font-size:12px;"><span>Home</span><span>Docs</span></span></nav>`,
  },
];
