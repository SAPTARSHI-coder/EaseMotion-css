...
<div class="ease-tabs ease-tabs-underline ease-tabs-fade">
  <div class="ease-tab-list">
    <button class="ease-tab ease-tab-active" data-target="home">Home</button>

    <button class="ease-tab" data-target="profile">Profile</button>
  </div>

  <div class="ease-tab-panel ease-tab-active" id="home">Home Content</div>

  <div class="ease-tab-panel" id="profile">Profile Content</div>
</div>
```
