...
This example demonstrates the usage of `ease-flip-x` and `ease-flip-y` animation utilities.
...
Open `demo.html` in your browser to test out the flip animations on a sample card component.
