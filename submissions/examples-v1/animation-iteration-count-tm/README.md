# animation-iteration-count-tm

## CSS CSS animation-iteration-count loop control

A comprehensive CSS utility class for **CSS animation-iteration-count loop control**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-animation-iteration-count-tm">
  <span>CSS animation-iteration-count loop control</span>
</div>

<!-- Variant 1: left-accent border -->
<div
  class="tm-animation-iteration-count-tm tm-animation-iteration-count-tm-variant-1"
>
...
<div
  class="tm-animation-iteration-count-tm tm-animation-iteration-count-tm-variant-2"
>
...
<div
  class="tm-animation-iteration-count-tm tm-animation-iteration-count-tm-variant-3"
>
...
<div
  class="tm-animation-iteration-count-tm tm-animation-iteration-count-tm-variant-4"
>
