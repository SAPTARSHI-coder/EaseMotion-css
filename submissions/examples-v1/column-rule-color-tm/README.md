# column-rule-color-tm

## CSS CSS column-rule-color divider styling

A comprehensive CSS utility class for **CSS column-rule-color divider styling**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-column-rule-color-tm">
  <span>CSS column-rule-color divider styling</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-column-rule-color-tm tm-column-rule-color-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-column-rule-color-tm tm-column-rule-color-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-column-rule-color-tm tm-column-rule-color-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-column-rule-color-tm tm-column-rule-color-tm-variant-4">
