...
## CSS CSS cursor zoom-in pointer feedback

A comprehensive CSS utility class for **CSS cursor zoom-in pointer feedback**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-cursor-zoom-in-tm">
  <span>CSS cursor zoom-in pointer feedback</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-cursor-zoom-in-tm tm-cursor-zoom-in-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-cursor-zoom-in-tm tm-cursor-zoom-in-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-cursor-zoom-in-tm tm-cursor-zoom-in-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-cursor-zoom-in-tm tm-cursor-zoom-in-tm-variant-4">
