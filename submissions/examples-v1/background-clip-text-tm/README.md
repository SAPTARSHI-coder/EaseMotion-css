# background-clip-text-tm

## CSS CSS background-clip text fill effects

A comprehensive CSS utility class for **CSS background-clip text fill effects**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-background-clip-text-tm">
  <span>CSS background-clip text fill effects</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-background-clip-text-tm tm-background-clip-text-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-background-clip-text-tm tm-background-clip-text-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-background-clip-text-tm tm-background-clip-text-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-background-clip-text-tm tm-background-clip-text-tm-variant-4">
