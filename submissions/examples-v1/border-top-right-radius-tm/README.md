# border-top-right-radius-tm

## CSS CSS border-top-right-radius individual corners

A comprehensive CSS utility class for **CSS border-top-right-radius individual corners**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-border-top-right-radius-tm">
  <span>CSS border-top-right-radius individual corners</span>
</div>
