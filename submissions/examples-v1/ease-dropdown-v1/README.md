...
<div class="dropdown">
  ...
  <button
    class="ease-btn ease-btn-primary dropdown-trigger"
    aria-haspopup="menu"
    type="button"
  >
    Options
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li role="none">
      <a class="dropdown-item" href="#" role="menuitem" tabindex="-1"
        >Duplicate</a
      >
    </li>
...
- **Distinct from `ease-accordion`**: the accordion expands _inline_ and pushes content down; the dropdown floats _above_ the document via `position: absolute`, making it suited for navigation bars, action menus, and context menus.
