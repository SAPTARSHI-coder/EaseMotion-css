...
Circle ellipse polygon clip-path shapes using ease-radius and ease-color tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-\* variables) for consistent styling across your project.
