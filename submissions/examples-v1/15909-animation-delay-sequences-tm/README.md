...
```html
<ul class="list">
  <li class="item ease-fade-in ease-delay-sequence" style="--delay-index: 1;">
    Item 1
  </li>
  <li class="item ease-fade-in ease-delay-sequence" style="--delay-index: 2;">
    Item 2
  </li>
  <li class="item ease-fade-in ease-delay-sequence" style="--delay-index: 3;">
    Item 3
  </li>
</ul>
```
