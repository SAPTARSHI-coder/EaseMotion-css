...
- **Contextual Dimming**: Uses modern CSS `:has()` to slightly dim and scale down the avatars that are _not_ currently being hovered, directing focus to the active one.
