# drop-shadow-filter-tm

## CSS CSS filter drop-shadow utilities

A comprehensive CSS utility class for **CSS filter drop-shadow utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-drop-shadow-filter-tm">
  <span>CSS filter drop-shadow utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-drop-shadow-filter-tm tm-drop-shadow-filter-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-drop-shadow-filter-tm tm-drop-shadow-filter-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-drop-shadow-filter-tm tm-drop-shadow-filter-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-drop-shadow-filter-tm tm-drop-shadow-filter-tm-variant-4">
