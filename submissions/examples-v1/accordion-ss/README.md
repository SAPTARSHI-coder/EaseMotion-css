...
```html
&lt;div class="ease-accordion"&gt; &lt;div class="ease-accordion-item"&gt;
&lt;label class="ease-accordion-header" for="acc-1"&gt; Click to expand &lt;svg
class="ease-accordion-icon"&gt;...&lt;/svg&gt; &lt;/label&gt; &lt;input
type="checkbox" id="acc-1" class="ease-accordion-input"&gt; &lt;div
class="ease-accordion-content"&gt; &lt;div&gt; &lt;p&gt;Hidden content
