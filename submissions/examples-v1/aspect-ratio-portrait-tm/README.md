# aspect-ratio-portrait-tm

## CSS CSS aspect-ratio portrait orientation

A comprehensive CSS utility class for **CSS aspect-ratio portrait orientation**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-aspect-ratio-portrait-tm">
  <span>CSS aspect-ratio portrait orientation</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-aspect-ratio-portrait-tm tm-aspect-ratio-portrait-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-aspect-ratio-portrait-tm tm-aspect-ratio-portrait-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-aspect-ratio-portrait-tm tm-aspect-ratio-portrait-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-aspect-ratio-portrait-tm tm-aspect-ratio-portrait-tm-variant-4">
