...
function init() {
  ...
  document
    .getElementById("speedSlow")
    .addEventListener("click", () => (rotationSpeed = 0.002));
  document
    .getElementById("speedNormal")
    .addEventListener("click", () => (rotationSpeed = 0.005));
  document
    .getElementById("speedFast")
    .addEventListener("click", () => (rotationSpeed = 0.012));
