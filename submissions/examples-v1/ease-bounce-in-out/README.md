...
This example demonstrates the usage of `ease-bounce-in` and `ease-bounce-out` animation utilities.
...
Include the `style.css` containing the animations, then apply the classes to your HTML elements.
...
Open `demo.html` in your browser to see the effect applied to a sample modal component.
