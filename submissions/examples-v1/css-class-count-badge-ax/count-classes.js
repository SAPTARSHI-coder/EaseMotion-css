...
const ANIMATION_PATTERNS =
  /ease-(fade|slide|zoom|bounce|pulse|rotate|flip|ping|spin|shake|wobble|tada|jello|heartBeat|hinge|jackInTheBox|rollIn|rollOut|lightSpeed|swing|flash|headShake)/;
const UTILITY_PATTERNS =
  /ease-(container|flex|grid|text-|font-|bg-|p-|m-|gap-|w-|h-|rounded|shadow|opacity|overflow|relative|absolute|fixed|sticky|top-|bottom-|left-|right-|inset-|z-|cursor|select|pointer|hidden|block|inline|inline-block|list-|space-|justify-|items-|self-|order|col-|row-)/;
const COMPONENT_PATTERNS =
  /ease-(btn|card|input|badge|chip|tag|modal|tooltip|toast|navbar|sidebar|avatar|spinner|loader|progress|table|form)/;
