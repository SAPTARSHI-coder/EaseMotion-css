# CSS Cursor Pointer Variants

**Category:** Interaction
**Slug:** `cursor-pointer-tm`

## Overview

Cursors, scroll, selection, and user interaction styles.

This submission provides a comprehensive set of CSS utility classes for **CSS Cursor Pointer Variants**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
<link
  rel="stylesheet"
  href="submissions/examples/cursor-pointer-tm/style.css"
/>
```
...
```
submissions/examples/cursor-pointer-tm/
  demo.html    — Interactive demo with live examples
  style.css    — 206+ meaningful CSS lines
