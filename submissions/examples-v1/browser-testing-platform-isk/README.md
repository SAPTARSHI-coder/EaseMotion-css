...
- **Entrance & Hover Animations**:
  ...
  - `.ease-hover-lift`: Used for the interactive pricing calculator card and browser grid cards.
  - `.ease-hover-underline`: Applied to nav menu links.
  - `.ease-card-lift`: Used for developer feature cards and customer reviews.
