# border-bottom-left-radius-tm

## CSS CSS border-bottom-left-radius individual corners

A comprehensive CSS utility class for **CSS border-bottom-left-radius individual corners**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-border-bottom-left-radius-tm">
  <span>CSS border-bottom-left-radius individual corners</span>
</div>

<!-- Variant 1: left-accent border -->
<div
  class="tm-border-bottom-left-radius-tm tm-border-bottom-left-radius-tm-variant-1"
>
...
<div
  class="tm-border-bottom-left-radius-tm tm-border-bottom-left-radius-tm-variant-2"
>
...
<div
  class="tm-border-bottom-left-radius-tm tm-border-bottom-left-radius-tm-variant-3"
>
...
<div
  class="tm-border-bottom-left-radius-tm tm-border-bottom-left-radius-tm-variant-4"
>
