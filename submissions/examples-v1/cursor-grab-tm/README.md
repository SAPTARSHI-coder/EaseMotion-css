...
This submission provides a comprehensive set of CSS utility classes for **CSS Cursor Grab Variants**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/cursor-grab-tm/style.css" />
```
...
```
submissions/examples/cursor-grab-tm/
