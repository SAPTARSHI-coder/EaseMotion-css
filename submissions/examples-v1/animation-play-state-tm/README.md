...
Shows animation-play-state running paused with interactive play pause demos. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-\* variables) for consistent styling across your project.
