# column-rule-style-tm

## CSS CSS column-rule-style line style

A comprehensive CSS utility class for **CSS column-rule-style line style**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-column-rule-style-tm">
  <span>CSS column-rule-style line style</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-column-rule-style-tm tm-column-rule-style-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-column-rule-style-tm tm-column-rule-style-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-column-rule-style-tm tm-column-rule-style-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-column-rule-style-tm tm-column-rule-style-tm-variant-4">
