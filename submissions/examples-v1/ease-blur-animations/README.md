# Blur In / Blur Out Animations

This example demonstrates the usage of `ease-blur-in` and `ease-blur-out` animation utilities.
...
These animations are great for modern UIs, modal dialog reveals, or lazy-loading placeholders.
...
Open `demo.html` in your browser to see the animations in action.
