...
Custom checkbox background fill animation on tick using CSS transitions and :checked state. Zero JavaScript required.

## Usage

    <label class="ease-checkbox ease-checkbox-primary">
      <input type="checkbox" />
      <span class="ease-checkbox-label">Check me</span>
    </label>
...
- Works with any HTML checkbox input
- Combine color + size + shape variants freely
- ease-checkbox-strike is great for todo list items
- ease-checkbox-bounce adds a satisfying spring pop on check
