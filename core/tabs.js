  ...
  function initializeTabs() {
    ...
    Array.prototype.forEach.call(
      ...
      function (container, containerIndex) {
        ...
        if (numTabs > CSS_LIMIT) {
          ...
          for (var i = CSS_LIMIT + 1; i <= numTabs; i++) {
            ...
            cssRules +=
              '[data-tabs-id="' +
              containerId +
              '"] .ease-tab-input:nth-of-type(' +
              i +
              "):focus-visible ~ .ease-tabs-nav .ease-tab-label:nth-of-type(" +
              i +
              ") { outline: 2px solid var(--ease-color-primary); outline-offset: -2px; }\n";
            ...
            cssRules +=
              ...
              '"] .ease-tab-input:nth-of-type(' +
              i +
              "):checked ~ .ease-tabs-nav .ease-tab-label:nth-of-type(" +
              i +
            ...
            cssRules +=
              ...
              '"] .ease-tab-input:nth-of-type(' +
              i +
              "):checked ~ .ease-tabs-nav .ease-tab-underline { transform: translateX(" +
              translatePercent +
              "%); }\n";
            ...
            cssRules +=
              ...
              '"] .ease-tab-input:nth-of-type(' +
              i +
              "):checked ~ .ease-tabs-content .ease-tab-panel:nth-of-type(" +
              i +
              ") { display: block; }\n";
            ...
            if (container.classList.contains("ease-tabs-auto")) {
              cssRules +=
                '[data-tabs-id="' +
                containerId +
                '"].ease-tabs-auto .ease-tab-input:nth-of-type(' +
                i +
                "):checked ~ .ease-tabs-nav .ease-tab-label:nth-of-type(" +
                i +
        ...
        var underline = container.querySelector(
